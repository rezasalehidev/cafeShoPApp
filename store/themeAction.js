...
export const toggleThemeSuccess = (selectedTheme) => ({ type: TOGGLE_THEME_SUCCESS, payload: { selectedTheme } });
export const toggleThemeFailure = (error) => ({ type: TOGGLE_THEME_FAILURE, payload: error });
